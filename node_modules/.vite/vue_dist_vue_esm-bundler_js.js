...
var WITH_SCOPE_ID = Symbol(true ? `withScopeId` : ``);
...
function createRootCodegen(root, context) {
  ...
  if (children.length === 1) {
    ...
    root.codegenNode = createVNodeCall(context, helper(FRAGMENT), void 0, root.children, patchFlag + (true ? ` /* ${patchFlagText} */` : ``), void 0, void 0, true);
  } else
    ;
}
...
function createChildrenCodegenNode(branch, keyIndex, context) {
  ...
  if (needFragmentWrapper) {
    if (children.length === 1 && firstChild.type === 11) {
      ...
      return createVNodeCall(context, helper(FRAGMENT), createObjectExpression([keyProperty]), children, patchFlag + (true ? ` /* ${patchFlagText} */` : ``), void 0, void 0, true, false, branch.loc);
    }
  } else {
    const vnodeCall = firstChild.codegenNode;
...
var transformFor = createStructuralDirectiveTransform("for", (node, dir, context) => {
  ...
  return processFor(node, dir, context, (forNode) => {
    ...
    forNode.codegenNode = createVNodeCall(context, helper(FRAGMENT), void 0, renderExp, fragmentFlag + (true ? ` /* ${PatchFlagNames[fragmentFlag]} */` : ``), void 0, void 0, true, !isStableFragment, node.loc);
    return () => {
      let childBlock;
      ...
      if (slotOutlet) {
        ...
        childBlock = createVNodeCall(context, helper(FRAGMENT), keyProperty ? createObjectExpression([keyProperty]) : void 0, node.children, 64 + (true ? ` /* ${PatchFlagNames[64]} */` : ``), void 0, void 0, true);
      } else {
